                         ...
                         // all but the new book 
                            ...
                            <?php
                                    ...
                                    <?php //php-inject the image source default img if no DB entry
                                        ...
                                        <img src="<?php echo $img; ?>" class="rounded float-start" width="60" alt="<?php echo $myBook->getImage(); ?>">
                                    </td>
                                    ...
                                    <td><div><button type="button" onclick="deleteBookFromDB(<?php echo $book_ID; ?>)" class="btn btn-outline-warning" style="font-size:12px" data-bs-toggle="modal" data-bs-target="#bookedit<?php echo $book_ID; ?>">Löschen </button></div></td>
