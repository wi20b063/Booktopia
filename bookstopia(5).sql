...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2023 at 02:13 PM
...
CREATE TABLE `book` (
  `id` int(10) NOT NULL,
  `image_url` text DEFAULT '/Frontend/res/img/default.png',
  `titel` text NOT NULL,
  `autor` text NOT NULL,
  `preis` int(11) NOT NULL,
  `bewertung` int(11) NOT NULL DEFAULT 1,
  `kategorie` enum('Biographie','Sachbuch','Krimi','Allgemein') DEFAULT 'Allgemein',
  `language` enum('Deutsch','Englisch','Französisch','Andere') DEFAULT 'Deutsch',
  `isbn` varchar(17) DEFAULT '111',
  `description` varchar(255) DEFAULT 'Kurzbeschreibung',
...
(1, '/Frontend/res/img/Queen Charlotte.PNG', 'Queen Charlotte', 'Julia Quinn + weitere', 13, 5, 'Biographie', 'Englisch', '978-344215147', 'Ein schrecklicher Fund im Büro des Commissioner stellt alle vor ein...', 20),
(2, '/Frontend/res/img/West Well.PNG', 'West Well', 'Lena Kiefer', 15, 4, 'Allgemein', 'Deutsch', '42342356789', '', 20),
(3, '/Frontend/res/img/Die 1 Methode.PNG', 'Die 1% Methode', 'James Clear', 14, 4, 'Sachbuch', 'Englisch', '', 'Abnehmen für dummies', 5),
(4, '/Frontend/res/img/Wald Wissen.PNG', 'Wald Wissen', 'Peter Wohlleben + weitere', 30, 1, 'Sachbuch', 'Englisch', '', 'No description available', 3),
(5, '/Frontend/res/img/cafeaEdW.jpg', 'Das Café am Rande der Welt: eine Erzählung über den Sinn des Lebens', 'John Strelecky', 11, 4, 'Allgemein', 'Deutsch', '978-3423209694', 'Ein Buch das zum Nachdenken anregt', 6),
(7, '/Frontend/res/img/default.png', 'Neuer Titel', 'Mr Bean', 64, 0, 'Biographie', 'Englisch', '12345-4564', 'gjgjhfghgf', 4);
...
(18, 'Frau', 'Master', 'Master', 'Master 1', 1111, 'Master', 'Master@bookstopia.at', 'Master', 'masterpw ', 1, 1),
(19, 'Frau', 'Test', 'Admin', 'Weg 1', 1010, 'Wien', 'admin@test.at', 'testAdmin', 'fa585d89c851dd338a70dcf535aa2a92fee7836dd6aff1226583e88e0996293f16bc009c652826e0fc5c706695a03cddce372f139eff4d13959da6f1f5d3eabe', 1, 1),
...
(45, 'Frau', 'PTest', 'QTest', 'LTest 35', 1145, 'Wien', 'testtt@tt.com', 'ptest', 'fa585d89c851dd338a70dcf535aa2a92fee7836dd6aff1226583e88e0996293f16bc009c652826e0fc5c706695a03cddce372f139eff4d13959da6f1f5d3eabe', 0, 0),
...
(53, 'Frau', 'Test', 'TestA', 'aaa', 1111, 'Wien', 'wer@ff.com', 'xxx', 'fa585d89c851dd338a70dcf535aa2a92fee7836dd6aff1226583e88e0996293f16bc009c652826e0fc5c706695a03cddce372f139eff4d13959da6f1f5d3eabe', 1, 1);
